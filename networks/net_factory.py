...
from networks.unet import UNet, MiMUNet, UNet_DS, UNet_URPC, UNet_CCT
import argparse
...
parser.add_argument('--iternum', type=int, default=200, help='labeled data')
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "mimunet":
        net = MiMUNet(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "enet":
